...
public class LoginAdapterBasedAuth extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_login_adapter_based_auth);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.login_adapter_based_auth, menu);
		return true;
	}
